 ...
 */
export async function sendWelcomeEmail({ to, firstName, inviteLink, amountLabel, dateLabel }) {
...
<html><body style="font-family:system-ui,-apple-system,sans-serif;color:#1F2226;max-width:560px;margin:0 auto;padding:24px;background:#FAF6EA;">
  ...
  <p style="margin:20px 0;">
    <a href="${meUrl}" style="display:inline-block;background:#1F2226;color:#FAF6EA;text-decoration:none;padding:13px 26px;border-radius:8px;font-weight:600;">Otvori svoje Premium dealove →</a>
  </p>
  ...
  const text = [
    ...
    ...(amountLabel || dateLabel
      ...
      : []),
    '',
    'Otvori svoje Premium dealove (aviokompanija, vremena, booking linkovi):',
    meUrl,
    '',
