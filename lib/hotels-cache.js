...
export function buildCacheKey({ destination, checkIn, checkOut, adults, children }) {
  // v2 adds the transparent stay-details shape. Versioning avoids serving a
  // prior cached list that cannot honestly describe room/rate scope.
  return `v2_${destination}_${checkIn}_${checkOut}_${adults}_${children || 0}`;
}
